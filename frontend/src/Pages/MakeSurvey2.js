...
//     <h4>輸入獎品資訊</h4>
//       <p>
//           <input type="text" placeholder="輸入獎品名稱" style={{width: "60%", height:"40px", border:' 2px solid #8864b3'}}/>
//       </p>
//       <p>
...
//         <div>
//           <button className='giftBtn Btn' onClick={()=>{setGiftNum(giftNum+1)}}>
//           新增禮物
//           </button>
...
//                 </div>
//                 <div className='BtnGroupContainer' style={ {position:'relative', left:'30%'}}>
