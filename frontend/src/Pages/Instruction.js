...
​
                    ...
                    <p>
                    <h4>個人資料之安全</h4>
                    <p>在未經會員同意之下，我們不會將會員的個人資料提供予第三人。會員應妥善保密自己的網路密碼及個人資料，不要將任何個人資料，尤其是網路密碼提供給任何人。在使用完Formalot所提供的服務後，務必記得登出帳戶，若是與他人共享電腦或使用公共電腦，切記要關閉瀏覽器視窗。</p>
                    <h4>個人資料的蒐集、處理、利用</h4>
                    <p>網站所取得的個人資料，都僅供Formalot於其內部、依照原來所說明的使用目的和範圍，除非事先說明、或依照相關法律規定，否則不會將資料提供給第三人、或移作其他目的使用。</p>
                    <h4>資料安全</h4>
                    <p>為保障會員的隱私及安全，Formalot會以合理之技術及程序對用戶密碼進行保護，保障所有個人資料之安全。</p>
                    </p>
            </div>
        </section>
        <Footer/> 
